...
var logActivity = function (userId, action, targetId, targetType, metadata) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, activity_model_1.Activity.create({
                        user: userId,
                        action: action,
                        targetId: targetId,
