...
exports.verifyJWT = (0, asyncHandler_1.asyncHandler)(function (req, _, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.User.findById(decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken._id).select("-password -refreshToken")];
            case 1:
                user = _c.sent();
                if (!user) {
            ...
            case 2:
                error_1 = _c.sent();
                throw new ApiError_1.ApiError(401, (error_1 === null || error_1 === void 0 ? void 0 : error_1.message) || "Invalid access token");
